			...
			>
				{!selectedFile ? (
					<>
						...
						<p className="mt-4 text-fluid-lg font-medium">
							{t("upload.fileUpload")}
						</p>
						<p className="mt-2 text-fluid-sm text-base-content/60">
							{t("upload.documentTypeHint")}
						</p>
						<p className="text-center text-fluid-xs text-slate-400">
					...
					<div className="flex items-center justify-center gap-4">
						...
						<div className="text-left">
							...
							<p className="text-fluid-sm text-base-content/60">
